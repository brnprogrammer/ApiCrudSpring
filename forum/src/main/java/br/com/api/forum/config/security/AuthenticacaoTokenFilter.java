...
public class AuthenticacaoTokenFilter extends OncePerRequestFilter{
	...
	public AuthenticacaoTokenFilter(TokenService tokenService, UserRepository usuarioRepository) {
	...
	private String recuperarToken(HttpServletRequest request) {
		String token = request.getHeader("Authorization"); //recupera o cabeçalho com o token
